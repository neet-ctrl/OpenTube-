...
<p align="center"><a href="https://f-droid.org/packages/org.schabi.opentube/"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on-tr.svg" alt="Get it on F-Droid" width=206/></a></p>

<p align="center">
<a href="https://github.com/TeamOpenTube/OpenTube/releases" alt="GitHub sürümleri"><img src="https://img.shields.io/github/release/TeamOpenTube/OpenTube.svg" ></a>
...
<a href="https://github.com/TeamOpenTube/OpenTube/actions" alt="Derleme Durumu"><img src="https://github.com/TeamOpenTube/OpenTube/actions/workflows/ci.yml/badge.svg?branch=dev&event=push"></a>
<a href="https://hosted.weblate.org/engage/opentube/" alt="Çeviri Durumu"><img src="https://hosted.weblate.org/widgets/opentube/-/svg-badge.svg"></a>
</p>

<p align="center">
<a href="https://web.libera.chat/#opentube" alt="IRC kanalı: #opentube"><img src="https://img.shields.io/badge/IRC%20chat-%23opentube-brightgreen.svg"></a>
...
<p align="center"><a href="https://opentube.net">Web sitesi</a> &bull; <a href="https://opentube.net/blog/">Blog</a> &bull; <a href="https://opentube.net/FAQ/">SSS</a> &bull; <a href="https://opentube.net/press/">Basın</a></p>
<hr>
...
OpenTube birden fazla hizmeti destekler. Uygulamaya ve ayıklayıcıya yeni bir hizmet ekleme konusunda daha fazla bilgiye [kılavuzlarımızdan](https://teamopentube.github.io/documentation/) ulaşabilirsiniz. Yeni bir hizmet eklemek istiyorsanız lütfen bizimle iletişime geçin. Şu anda desteklenen hizmetler şunlardır:
...
Aşağıdaki yöntemlerden birini kullanarak OpenTube'ı kurabilirsiniz:
 1. Özel depomuzu F-Droid'e ekleyin ve oradan yükleyin. Kılavuzu şurada bulabilirsiniz: https://opentube.net/FAQ/tutorials/install-add-fdroid-repo/
 2. APK'yı [GitHub sürümlerinden](https://github.com/TeamOpenTube/OpenTube/releases) indirin ve kurun.
...
Bu arada, herhangi bir nedenle kaynakları değiştirmek istiyorsanız (örneğin, OpenTube'ın temel bir işlevi bozuldu ve F-Droid tarafında henüz bir güncelleme yayınlanmadı), bu prosedürü izlemenizi öneririz:
1. Verilerinizi yedekleyin. `OpenTube Ayarları > İçerik > Veritabanını dışa aktar` seçeneklerini izleyerek aboneliklerinizi, oynatma listelerinizi ve geçmişinizi yedekleyin.
2. OpenTube'ı kaldırın
...
Yapılan her değişiklikle OpenTube daha da iyi bir konuma geliyor!
...
<img src="https://hosted.weblate.org/widgets/opentube/-/287x66-grey.png" alt="Çeviri istatistikleri" />
</a>

## Bağış
OpenTube'ı beğendiyseniz, yapacağınız bağışlar bizi motive eder. Bitcoin gönderebilir veya Bountysource veya Liberapay aracılığıyla bağış yapabilirsiniz. OpenTube'a bağış yapma hakkında daha fazla bilgi için lütfen [web sitemizi](https://opentube.net/donate) ziyaret edin.
...
<table>
  <tr>
    ...
    <td><a href="https://liberapay.com/TeamOpenTube/"><img src="../assets/liberapay_qr_code.png" alt="liberapay.com üzerinde OpenTube'ı ziyaret edin" width="100px"></a></td>
    <td><a href="https://liberapay.com/TeamOpenTube/donate"><img src="../assets/liberapay_donate_button.svg" alt="Liberapay aracılığıyla bağış yapın" height="35px"></a></td>
  </tr>
</table>

## Gizlilik politikası

OpenTube projesi, çevrimiçi akış hizmetlerini kullanmak için özel, özgür ve anonim bir deneyim sunmayı amaçlamaktadır.
Bu doğrultuda, uygulama sizin izniniz olmadan herhangi bir veri toplamaz. OpenTube'ın Gizlilik Politikası, bir çökme raporu gönderdiğinizde veya blogumuzda yorum yaptığınızda hangi verilerin gönderildiğini ve saklandığını ayrıntılı olarak açıklar. İlgili belgeyi [burada](https://opentube.net/legal/privacy/) bulabilirsiniz.

## Lisans
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.en.html)  

OpenTube özgür bir yazılımdır. Kendi başınıza kullanabilir, öğrenebilir, paylaşabilir
