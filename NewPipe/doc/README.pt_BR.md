<h3 align="center">Nós estamos planejando <i>reescrever</i> grandes pedaços do código base, para gerar <a href="https://github.com/TeamOpenTube/OpenTube/discussions/10118"> um novo, moderno e estável OpenTube</a>!</h3>
...
<p align="center"><a href="https://f-droid.org/packages/org.schabi.opentube/"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on-pt-br.svg" alt="Get it on F-Droid" width=206/></a></p>
...
<p align="center"><a href="https://opentube.net">Site</a> &bull; <a href="https://opentube.net/blog/">Blog</a> &bull; <a href="https://opentube.net/FAQ/">FAQ</a> &bull; <a href="https://opentube.net/press/">Press</a></p>
<hr>
...
Como você pode ver, o OpenTube suporta múltiplos serviços de vídeo e áudio. Embora tenha começado com o YouTube, outras pessoas adicionaram mais serviços ao longo dos anos, tornando o OpenTube cada vez mais versátil!
...
Se você pretende adicionar um novo serviço, por favor entre em contato conosco primeiro! Nossa [documentação](https://teamopentube.github.io/documentation/) traz mais informações em como um novo serviço pode ser adicionado ao aplicativo e no [OpenTube Extractor](https://github.com/TeamOpenTube/OpenTubeExtractor).

## Descrição

OpenTube funciona buscando os dados necessários da API oficial (ex. PeerTube) ou do serviço que você está usando. Se a API oficial é restrita (ex. YouTube) para nossos propósitos, ou é proprietária, o aplicativo analisa o site ou usa uma API interna. Isso significa que não é preciso ter uma conta de qualquer serviço para usar o OpenTube.

Também, desde que somos um software livre e de código aberto, nem o aplicativo e nem o Extractor usa qualquer biblioteca ou framework proprietário, como o Google Play Services. Isso significa que você pode usar o OpenTube em dispositivos ou ROMs customizadas em que não tem os aplicativos do Google instalados.
...
Você pode instalar OpenTube com um dos seguintes métodos: 
 1. Adicione nosso repo personalizado ao F-Droid e instale-o a partir daí. As instruções estão aqui: https://opentube.net/FAQ/tutorials/install-add-fdroid-repo/
 2. Baixe o APK aqui no [GitHub Releases](https://github.com/TeamOpenTube/OpenTube/releases) e instalá-lo assim que publicarmos um lançamento.
...
<img src="https://hosted.weblate.org/widgets/opentube/-/287x66-grey.png" alt="Estado da tradução" />
</a>

## Doar
Se você gosta do OpenTube, pode enivar uma doação. Nós preferimos Liberapay, pois é de código aberto e sem fins lucrativos. Para mais informações sobre como doar para o OpenTube, visite nosso [site](https://opentube.net/donate).
...
<table>
  <tr>
    ...
    <td><a href="https://liberapay.com/TeamOpenTube/"><img src="../assets/liberapay_qr_code.png" alt="Visite OpenTube em liberapay.com" width="100px"></a></td>
    <td><a href="https://liberapay.com/TeamOpenTube/donate"><img src="../assets/liberapay_donate_button.svg" alt="Doar via Liberapay" height="35px"></a></td>
  </tr>
</table>

## Política de Privacidade

O projeto OpenTube tem como objetivo proporcionar uma experiência privada e anônima para o uso de serviços web de mídia.
Portanto, o aplicativo não coleta nenhum dado sem o seu consentimento. A política de privacidade da OpenTube explica em detalhes quais dados são enviados e armazenados quando você envia um relatório de erro ou comenta em nosso blog. Você pode encontrar o documento [aqui](https://opentube.net/legal/privacy/).

## Licença
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.en.html)  

OpenTube é Software Livre: Você pode usar, estudar compartilhamento e melhorá-lo à sua vontade.
