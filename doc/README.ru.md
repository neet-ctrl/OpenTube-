...
<p align="center"><a href="https://f-droid.org/packages/org.schabi.opentube/"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on-en.svg" alt="Скачать на F-Droid" width=206/></a></p>
...
<a href="https://github.com/TeamOpenTube/OpenTube/actions" alt="Состояние сборки"><img src="https://github.com/TeamOpenTube/OpenTube/actions/workflows/ci.yml/badge.svg?branch=dev&event=push"></a>
<a href="https://hosted.weblate.org/engage/opentube/" alt="Состояние перевода"><img src="https://hosted.weblate.org/widgets/opentube/-/svg-badge.svg"></a>
</p>

<p align="center">
<a href="https://web.libera.chat/#opentube" alt="Канал IRC: #opentube"><img src="https://img.shields.io/badge/IRC%20chat-%23opentube-brightgreen.svg"></a>
...
<p align="center"><a href="https://opentube.net">Сайт</a> &bull; <a href="https://opentube.net/blog/">Блог</a> &bull; <a href="https://opentube.net/FAQ/">ЧЗВ</a> &bull; <a href="https://opentube.net/press/">Пресса</a></p>
<hr>
...
OpenTube на данный момент поддерживает эти сервисы:
...
Как видите, OpenTube поддерживает несколько видео- и аудиосервисов. Хотя все началось с YouTube, с годами люди добавляли новые сервисы, делая OpenTube все более и более универсальным!
...
Если вы хотите добавить новый сервис, сначала свяжитесь с нами! В нашей [документации](https://teamopentube.github.io/documentation/) содержится дополнительная информация о том, как можно добавить новый сервис в приложение и в [OpenTube Extractor](https://github.com/TeamOpenTube/OpenTubeExtractor).

## Описание

OpenTube работает, извлекая необходимые данные из официального API (например, PeerTube) сервиса, который вы используете. Если официальный API ограничен (например, YouTube) для наших целей или является проприетарным, приложение анализирует веб-сайт или использует вместо этого внутренний API. Это означает, что вам не нужна учетная запись в этих сервисах для использования OpenTube.

Кроме того, поскольку это бесплатное и открытое программное обеспечение, ни приложение, ни Extractor не используют какие-либо проприетарные библиотеки или платформы, такие как Google Play Services. Это означает, что вы можете использовать OpenTube на устройствах или пользовательских ROM, на которых не установлены приложения Google.
...
Вы можете установить OpenTube одним из следующих способов:
 1. Добавьте наш пользовательский репозиторий в F-Droid и установите его оттуда. Инструкции находятся здесь: https://opentube.net/FAQ/tutorials/install-add-fdroid-repo/
 2. Скачайте APK из [GitHub Releases](https://github.com/TeamOpenTube/OpenTube/releases) и установите его.
...
<img src="https://hosted.weblate.org/widgets/opentube/-/287x66-grey.png" alt="Состояние перевода">
</a>

## Пожертвование
Если вам нравится OpenTube, вы можете отправить пожертвование. Мы предпочитаем Liberapay, так как это открытая и некоммерческая платформа. Для получения дополнительной информации о пожертвовании OpenTube посетите наш [сайт](https://opentube.net/donate).
...
<table>
  <tr>
    ...
    <td><a href="https://liberapay.com/TeamOpenTube/"><img src="assets/liberapay_qr_code.png" alt="Посетите OpenTube на liberapay.com" width="100px"></a></td>
    <td><a href="https://liberapay.com/TeamOpenTube/donate"><img src="assets/liberapay_donate_button.svg" alt="Пожертвование через Liberapay" height="35px"></a></td>
  </tr>
</table>

## Политика конфиденциальности

Целью проекта OpenTube является предоставление конфиденциального анонимного доступа к мультимедийным веб-сервисам. Поэтому приложение не собирает никаких данных без вашего согласия. Политика конфиденциальности OpenTube подробно объясняет, какие данные отправляются и сохраняются, когда вы отправляете отчёт о сбое или оставляете комментарий в нашем блоге. Вы можете найти документ [здесь](https://opentube.net/legal/privacy/).

## Лицензия
[![Изображение GNU GPLv3](https://www.gnu.org/graphics/gplv3-127x51.png)](https://www.gnu.org/licenses/gpl-3.0.ru.html)  

OpenTube — это бесплатное программное обеспечение: вы можете использовать, изучать, делиться и улучшать его по своему усмотрению. В частности, вы можете распространять и/или изменять ее в соответствии с условиями [Стандартной общественной лицензии GNU](https://www.gnu.org/licenses/gpl.html) (GPL-3.0), опубликованной Free Software Foundation, либо версии 3 Лицензии или (на ваш выбор) любая более поздняя версия.
